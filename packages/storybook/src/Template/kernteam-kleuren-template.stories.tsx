      ...
      <UtrechtPage>
        <UtrechtPageContent>
          <UtrechtDocument>
            ...
            <UtrechtParagraph>
              Als je kleuren gebruikt doe je dat met een bepaald doel, hierdoor hebben ze een betekenis. Het is
              belangrijk dat die kleur consistent hoort bij die betekenis. Bijvoorbeeld: rood wordt gebruikt om risico
              aan te geven, of een blokkade door een foutmelding. Gebruik rood dan niet wanneer je juist wél ergens op
              moet klikken, zoals een link of een verzendknop.
            </UtrechtParagraph>
            <UtrechtParagraph>
              <Strong>Inzicht vanuit onderzoek.</Strong> Uit een onderzoek van Gemeente Utrecht blijkt dat
              laaggeletterden afschrikken van de kleur rood. Bijvoorbeeld als achtergrondkleur van een knop. De tekst
              wordt niet gelezen, de laaggeletterde acteert op kleur. Deze kleur wordt daarom niet langer als standaard
              interactie kleur toegepast.
            </UtrechtParagraph>
            ...
            <UtrechtParagraph>
              ...
              het sterkste signaal voor links, maar andere kleuren werken bijna net zo goed. Gebruik de gekozen kleur
              voor interactie daarna niet meer voor niet-interactieve elementen.
            </UtrechtParagraph>
            ...
            <UnorderedList>
              ...
              <UnorderedListItem>
                ...
                ‘invalid’). Verander dan niet alleen de kleur maar kies ook voor een donkerdere of lichtere tint, of
                maak de lijnen en tekst dikker.
              </UnorderedListItem>
              <UnorderedListItem>
                <Strong>Last ervaren van een te hoog contrast.</Strong> Gebruik daarom geen puur zwarte tekst op een
                puur witte achtergrond. Zo’n sterk contrast (21:1) kan ertoe leiden dat mensen tekst wazig, bewegend of
                flikkerend ervaren. Dit staat bekend als het{' '}
                <UtrechtLink href="https://en.m.wikipedia.org/wiki/Irlen_syndrome">Irlen-syndroom.</UtrechtLink>{' '}
                Overweeg daarom het contrast te beperken tot bijvoorbeeld 17:1. Kies als tekstkleur bijvoorbeeld niet
                zwart, maar donker grijs.
              </UnorderedListItem>
              <UnorderedListItem>
              ...
              <UnorderedListItem>
                ...
                lezen, of als je laaggeletterd bent, dan kunnen kleuren essentieel zijn om de betekenis te begrijpen.
                Rood is fout, groen is goed, amber is een waarschuwing. Schrik deze gebruikers niet onnodig af door rood
                te gebruiken voor acties die ongevaarlijk zijn om aan te klikken.
              </UnorderedListItem>
              <UnorderedListItem>
            ...
            <UtrechtParagraph>
              ...
              is dit te detecteren en kun je deze mensen passend kleurenthema aanbieden. Maar ze zouden ook gebruik
              kunnen maken van{' '}
              <UtrechtLink href="https://support.microsoft.com/en-us/windows/change-color-contrast-in-windows-fedc744c-90ac-69df-aed5-c8a90125e696">
                Windows high contrast mode
              </UtrechtLink>
            ...
            <UtrechtParagraph>
              ...
              <UtrechtParagraph>
                ...
                kleurcombinatie oplevert. Daarnaast heb je de mogelijkheid om via een colorpicker naar voldoende
                contrast op zoek te gaan.
              </UtrechtParagraph>
            </UtrechtParagraph>
            <UtrechtParagraph>
            ...
            <UtrechtParagraph>
              ...
              <UtrechtParagraph>
                Online tool waarbij je meerdere kleuren kunt invullen specifiek voor data visualisatie. Vervolgens kun
                je checken hoe deze kleurcombinatie overkomt bij verschillende visuele beperkingen.
              </UtrechtParagraph>
            </UtrechtParagraph>
            <UtrechtParagraph>
              <UtrechtLink href="https://chromewebstore.google.com/detail/colorblindly/floniaahmccleoclneebhhmnjgdfijgg">
